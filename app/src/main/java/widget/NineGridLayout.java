...
public abstract class NineGridLayout extends ViewGroup{
    ...
    private List<RatioImageView> mImgList = new ArrayList<>();
    ...
    private void refresh() {
        ...
        mImgList.clear(); //refresh方法会调用多次,避免重复计数我们需要每次再添加之前先清空容器
        if (size == 1) {
    ...
    private RatioImageView createImageView(final int i, final String url) {
        ...
        imageView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                onClickImage(i, url, mUrlList, mImgList);
            }
        });
        return imageView;
    }
...
//    }
    ...
    protected abstract void onClickImage(int position, String url, List<String> urlList, List<RatioImageView> imgList);
}
